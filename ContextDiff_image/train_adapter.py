...
class MultiCLIP(torch.nn.Module):
    def __init__(self, device="cpu"):
        super().__init__()
        model_32, _ = clip.load("./models/ViT-B-32.pt", device=device)
        model_16, _ = clip.load("./models/ViT-B-16.pt", device=device)
        model_101, _ = clip.load(".models/RN101.pt", device=device)
...
def parse_args():
    ...
    parser.add_argument(
        "--train_data_dir",
        type=str,
        default='path to your MS-COCO dataset',
        help=(
    ...
    parser.add_argument("--t5_model", type=str, default=None, help="Path to T5 model.")
    ...
    parser.add_argument("--mean_path", type=str, default='cluster/mean.pth',help="Path to mean of Gaussians of your dataset. If you didn't analyze your dataset to obtain it manually, you can use the file in our pre-trained models.")
    parser.add_argument("--std_path", type=str, default='cluster/std.pth',help="Path to std of Gaussians of your dataset. If you didn't  analyze your dataset to obtain it manually, you can use the file in our pre-trained models.")
    ...
    parser.add_argument("--linear_local_shift",type=bool, action='stroe_true', help="Use local linear or not.")
    parser.add_argument("--local_bilinear_shift", type=bool,  action='stroe_true', help="Use local bilinear or not.")
    parser.add_argument("--cross_attention_shift", type=bool,  action='stroe_true',help="Use cross attention or not.")
...
def main():
    ...
    use_local_linear=args.linear_local_shift
    use_local_bilinear=args.local_bilinear_shift
    use_cross_attention=args.cross_attention_shift
    ...
    model = ClipPrior(xf_width=args.model_width, xf_layers=args.model_layers, xf_heads=args.model_num_heads,
                      ...
                      vocab_std_scale=args.std_scale, vocab_lr_scale=args.vocab_lr_scale, vocab_exp=args.exp,local_linear=use_local_linear,local_Bilinear=use_local_bilinear)
            ...
            with accelerator.accumulate(model):
                ...
                losses = diffusion.training_losses(model, clip_image_emb, t, #emb_4_vocab=clip_image_emb,
                                                   model_kwargs=dict(emb_4_vocab=clip_text_emb, #clip_image_emb,
                                                    ...
                                                    clip_sentence_emb=input_clip_emb_modified,use_linear=use_local_linear,
                                                    use_bilinear=use_local_bilinear,
                                                    clip_image=clip_image_emb.detach().clone()
